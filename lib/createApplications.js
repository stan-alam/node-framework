...
var decodedjwt=jwt.verify(sessionStorage,'test scales right up');
if (decodedjwt)
{
  tenantId=decodedjwt.tenant.id;
}
 
  //turn on dataAccess flag for this tenant
 permissions.setDataAccessPermissions(tenantId,true);
