module.exports.xpaths = {
    ...
    applicationTabsText: "//span[contains(@class, 'section-title')][string-length(text()) > 0]",
    ...
    credentialsDeleteCancel: "//*[@id='delete_cancel_button']",
    credentialsDeleteConfirm: "//*[@id='delete_confirm_button']",
    ...
    findElementByClassEqualsTemplate: "//*[@class = 'TEMPLATE']",
